...
<head>
    ...
    <!-- <link rel="shortcut icon" href="public/frontend/images/star.png" type="favicon/ico" /> -->
    ...
    <link rel="stylesheet" href="public/frontend/css/pricing.css">
    <link rel="stylesheet" href="public/frontend/css/main.css">
    <link rel="stylesheet" href="public/frontend/css/bootstrap-datetimepicker.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css">
{{--     the code under below i do it to show the image that get it from the form     --}}
    <style>
        @foreach($slider as $key=>$sliders)
            .owl-carousel .owl-wrapper, .owl-carousel .owl-item:nth-child({{$key + 1}}) .item
            {
                background: url({{asset('backend/Images/'.$sliders->image)}});
    ...
    <script src="public/frontend/js/jquery-1.11.2.min.js"></script>
    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">
                <h2 style="color: #0b3251">Kitchen</h2>
            </a>
        </div>
    ...
    <div class="item">
        <div class="container">
            <div class="header-content">
                <h1 class="header-title">{{$sliders->title}}</h1>
                <p class="header-sub-title">{{$sliders->sub_title}}</p>
            </div> <!-- /.header-content -->
        </div>
    </div>
    @endforeach
...
<section id="about" class="about">
    <img src="public/frontend/images/icons/about_color.png" class="img-responsive section-icon hidden-sm hidden-xs">
    <div class="wrapper">
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <div class="section-header">
                                ...
                                <ul id="filter-list" class="clearfix">
                                    ...
                                    @foreach($cat as $cats)
                                        <li class="filter" data-filter="#{{$cats->slug}}">{{$cats->name}}
                                            <span class="badge">{{$cats->items->count()}}</span> </li>
                                    @endforeach
                                </ul><!-- @end #filter-list -->
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <ul id="menu-pricing" class="menu-price">
                        ...
                        <li class="item" id="{{$items->categories->slug}}">

                            <a href="#">
                                {{--public/frontend/images/food1.jpg--}}
                                <img src="{{asset('backend/Images/Item/'.$items->image)}}" class="img-responsive"
                                     alt="Item" style="height: 200px;width: 300px;">
                            ...
                            <h2 class="white">{{$items->price}}L.E</h2>
                        </li>
                        @endforeach
                    </ul>
...
<section id="great-place-to-enjoy" class="great-place-to-enjoy">
    <img class="img-responsive section-icon hidden-sm hidden-xs" src="public/frontend/images/icons/beer_black.png">
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row dis-table">
...
<section id="beer" class="beer">
    <img class="img-responsive section-icon hidden-sm hidden-xs" src="public/frontend/images/icons/beer_color.png">
    <div class="container-fluid">
        <div class="row dis-table">
...
<section id="breakfast" class="breakfast">
    <img class="img-responsive section-icon hidden-sm hidden-xs" src="public/frontend/images/icons/bread_black.png">
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row dis-table">
                <div class="col-xs-6 col-sm-6 dis-table-cell color-bg">
...
<section id="bread" class="bread">
    <img class="img-responsive section-icon hidden-sm hidden-xs" src="public/frontend/images/icons/bread_color.png">
    <div class="container-fluid">
        <div class="row dis-table">
            <div class="hidden-xs col-sm-6 dis-table-cell section-bg">
...
<section id="featured-dish" class="featured-dish">
    <img class="img-responsive section-icon hidden-sm hidden-xs" src="public/frontend/images/icons/food_black.png">
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row dis-table">
                <div class="col-xs-6 col-sm-6 dis-table-cell color-bg">
...
<section id="have-a-look" class="have-a-look hidden-xs">
    <img class="img-responsive section-icon hidden-sm hidden-xs" src="public/frontend/images/icons/food_color.png">
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="menu-gallery" style="width: 50%; float:left;">
                    <div class="flexslider-container">
                        <div class="flexslider">
                            <ul class="slides">
                                <li>
                                    <img src="public/frontend/images/menu-gallery/menu1.png" />
                                </li>
                                <li>
                                    <img src="public/frontend/images/menu-gallery/menu2.jpg" />
                                </li>
                                <li>
                                    <img src="public/frontend/images/menu-gallery/menu3.png" />
                                </li>
                                <li>
                                    <img src="public/frontend/images/menu-gallery/menu4.jpg" />
                                </li>
                                <li>
                                    <img src="public/frontend/images/menu-gallery/menu5.jpg" />
                                </li>
                                <li>
                                    <img src="public/frontend/images/menu-gallery/menu6.jpg" />
                                </li>
                                <li>
                                    <img src="public/frontend/images/menu-gallery/menu7.jpg" />
                                </li>
                                <li>
                                    <img src="public/frontend/images/menu-gallery/menu8.jpg" />
                                </li>
                                <li>
                                    <img src="public/frontend/images/menu-gallery/menu9.jpg" />
                                </li>
                                <li>
                                    <img src="public/frontend/images/menu-gallery/menu10.jpg" />
                                </li>
                                <li>
                                    <img src="public/frontend/images/menu-gallery/menu11.jpg" />
                                </li>
                            </ul>
                        </div>
                    </div>
...
<section id="reserve" class="reserve">
    <img class="img-responsive section-icon hidden-sm hidden-xs" src="public/frontend/images/icons/reserve_black.png">
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row dis-table">
                <div class="col-xs-6 col-sm-6 dis-table-cell color-bg">
...
<section class="reservation">
    <img class="img-responsive section-icon hidden-sm hidden-xs" src="public/frontend/images/icons/reserve_color.png">
    <div class="wrapper">
        <div class="container-fluid">
            <div class=" section-content">
                <div class="row">
                    <div class="col-md-5 col-sm-6">
                        <form class="reservation-form" method="post" action="{{route('user.reserve')}}">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control reserve-form empty iconified" name="dateandtime" id="datatimepicker1" required="required" placeholder="&#xf017;  Time">
                                    </div>
                                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                <div class="row">
                    <form class="contact-form" method="post" action="{{route('user.contact')}}">
                        @csrf
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
...
<script src="public/frontend/bootstrap.min.js"></script>
<script src="public/frontend/js/owl.carousel.min.js"></script>
<script type="text/javascript" src="public/frontend/js/jquery.mixitup.min.js" ></script>
...
<script type="text/javascript" src="public/frontend/js/jQuery.scrollSpeed.js"></script>
<script src="public/frontend/js/script.js"></script>
<script src="public/frontend/js/bootstrap-datetimepicker.min.js"></script>
